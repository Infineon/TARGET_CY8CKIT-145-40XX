...
#ifndef CY8C4045AZI_S413
    #error "Unexpected target MCU; expected CY8C4045AZI-S413. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
