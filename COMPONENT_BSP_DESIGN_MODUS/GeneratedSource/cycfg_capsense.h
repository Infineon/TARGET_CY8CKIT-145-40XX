...
#if !defined(Button2_Rx0_PORT) || !defined(Button2_Rx0_PIN)
#error Button2_Rx0 Sensor is not assigned: missing #define Button2_Rx0_PORT, #define Button2_Rx0_PIN
#endif

#if !defined(Button2_Tx_PORT) || !defined(Button2_Tx_PIN)
#error Button2_Tx Sensor is not assigned: missing #define Button2_Tx_PORT, #define Button2_Tx_PIN
#endif
...
/* Button2 node names */
#define CY_CAPSENSE_BUTTON2_RX0_TX0_ID                                           (0u)

/* Button2 sensor element IDs */
#define CY_CAPSENSE_BUTTON2_RX0_ID                                               (0u)
#define CY_CAPSENSE_BUTTON2_TX0_ID                                               (1u)
...
typedef struct {
    ...
    cy_stc_capsense_sensor_context_t sensorContext[8];
...
#define CY_CAPSENSE_BUTTON2_FINGER_CP_OFFSET                                     (136u)
#define CY_CAPSENSE_BUTTON2_FINGER_CP_SIZE                                       (2u)
#define CY_CAPSENSE_BUTTON2_FINGER_CP_PARAM_ID                                   (0x06020088u)

#define CY_CAPSENSE_BUTTON2_SIGPFC_VALUE                                         (cy_capsense_tuner.widgetContext[2].sigPFC)
#define CY_CAPSENSE_BUTTON2_SIGPFC_OFFSET                                        (138u)
#define CY_CAPSENSE_BUTTON2_SIGPFC_SIZE                                          (2u)
#define CY_CAPSENSE_BUTTON2_SIGPFC_PARAM_ID                                      (0x0602008au)

#define CY_CAPSENSE_BUTTON2_NUM_CONV_VALUE                                       (cy_capsense_tuner.widgetContext[2].resolution)
#define CY_CAPSENSE_BUTTON2_NUM_CONV_OFFSET                                      (140u)
#define CY_CAPSENSE_BUTTON2_NUM_CONV_SIZE                                        (2u)
#define CY_CAPSENSE_BUTTON2_NUM_CONV_PARAM_ID                                    (0x0602008cu)

#define CY_CAPSENSE_BUTTON2_MAXRAWCOUNT_VALUE                                    (cy_capsense_tuner.widgetContext[2].maxRawCount)
#define CY_CAPSENSE_BUTTON2_MAXRAWCOUNT_OFFSET                                   (142u)
#define CY_CAPSENSE_BUTTON2_MAXRAWCOUNT_SIZE                                     (2u)
#define CY_CAPSENSE_BUTTON2_MAXRAWCOUNT_PARAM_ID                                 (0x0202008eu)

#define CY_CAPSENSE_BUTTON2_FINGER_TH_VALUE                                      (cy_capsense_tuner.widgetContext[2].fingerTh)
#define CY_CAPSENSE_BUTTON2_FINGER_TH_OFFSET                                     (144u)
#define CY_CAPSENSE_BUTTON2_FINGER_TH_SIZE                                       (2u)
#define CY_CAPSENSE_BUTTON2_FINGER_TH_PARAM_ID                                   (0x06020090u)

#define CY_CAPSENSE_BUTTON2_PROX_TOUCH_TH_VALUE                                  (cy_capsense_tuner.widgetContext[2].proxTh)
#define CY_CAPSENSE_BUTTON2_PROX_TOUCH_TH_OFFSET                                 (146u)
#define CY_CAPSENSE_BUTTON2_PROX_TOUCH_TH_SIZE                                   (2u)
#define CY_CAPSENSE_BUTTON2_PROX_TOUCH_TH_PARAM_ID                               (0x06020092u)

#define CY_CAPSENSE_BUTTON2_LOW_BSLN_RST_VALUE                                   (cy_capsense_tuner.widgetContext[2].lowBslnRst)
#define CY_CAPSENSE_BUTTON2_LOW_BSLN_RST_OFFSET                                  (148u)
#define CY_CAPSENSE_BUTTON2_LOW_BSLN_RST_SIZE                                    (2u)
#define CY_CAPSENSE_BUTTON2_LOW_BSLN_RST_PARAM_ID                                (0x06020094u)

#define CY_CAPSENSE_BUTTON2_TX_CLK_VALUE                                         (cy_capsense_tuner.widgetContext[2].snsClk)
#define CY_CAPSENSE_BUTTON2_TX_CLK_OFFSET                                        (150u)
#define CY_CAPSENSE_BUTTON2_TX_CLK_SIZE                                          (2u)
#define CY_CAPSENSE_BUTTON2_TX_CLK_PARAM_ID                                      (0x06020096u)

#define CY_CAPSENSE_BUTTON2_ROW_SNS_CLK_VALUE                                    (cy_capsense_tuner.widgetContext[2].rowSnsClk)
#define CY_CAPSENSE_BUTTON2_ROW_SNS_CLK_OFFSET                                   (152u)
#define CY_CAPSENSE_BUTTON2_ROW_SNS_CLK_SIZE                                     (2u)
#define CY_CAPSENSE_BUTTON2_ROW_SNS_CLK_PARAM_ID                                 (0x06020098u)

#define CY_CAPSENSE_BUTTON2_GESTURE_DETECTED_VALUE                               (cy_capsense_tuner.widgetContext[2].gestureDetected)
#define CY_CAPSENSE_BUTTON2_GESTURE_DETECTED_OFFSET                              (154u)
#define CY_CAPSENSE_BUTTON2_GESTURE_DETECTED_SIZE                                (2u)
#define CY_CAPSENSE_BUTTON2_GESTURE_DETECTED_PARAM_ID                            (0x0202009au)

#define CY_CAPSENSE_BUTTON2_GESTURE_DIRECTION_VALUE                              (cy_capsense_tuner.widgetContext[2].gestureDirection)
#define CY_CAPSENSE_BUTTON2_GESTURE_DIRECTION_OFFSET                             (156u)
#define CY_CAPSENSE_BUTTON2_GESTURE_DIRECTION_SIZE                               (2u)
#define CY_CAPSENSE_BUTTON2_GESTURE_DIRECTION_PARAM_ID                           (0x0202009cu)

#define CY_CAPSENSE_BUTTON2_XDELTA_VALUE                                         (cy_capsense_tuner.widgetContext[2].xDelta)
#define CY_CAPSENSE_BUTTON2_XDELTA_OFFSET                                        (158u)
#define CY_CAPSENSE_BUTTON2_XDELTA_SIZE                                          (2u)
#define CY_CAPSENSE_BUTTON2_XDELTA_PARAM_ID                                      (0x0202009eu)

#define CY_CAPSENSE_BUTTON2_YDELTA_VALUE                                         (cy_capsense_tuner.widgetContext[2].yDelta)
#define CY_CAPSENSE_BUTTON2_YDELTA_OFFSET                                        (160u)
#define CY_CAPSENSE_BUTTON2_YDELTA_SIZE                                          (2u)
#define CY_CAPSENSE_BUTTON2_YDELTA_PARAM_ID                                      (0x020200a0u)

#define CY_CAPSENSE_BUTTON2_NOISE_TH_VALUE                                       (cy_capsense_tuner.widgetContext[2].noiseTh)
#define CY_CAPSENSE_BUTTON2_NOISE_TH_OFFSET                                      (162u)
#define CY_CAPSENSE_BUTTON2_NOISE_TH_SIZE                                        (1u)
#define CY_CAPSENSE_BUTTON2_NOISE_TH_PARAM_ID                                    (0x050200a2u)

#define CY_CAPSENSE_BUTTON2_NNOISE_TH_VALUE                                      (cy_capsense_tuner.widgetContext[2].nNoiseTh)
#define CY_CAPSENSE_BUTTON2_NNOISE_TH_OFFSET                                     (163u)
#define CY_CAPSENSE_BUTTON2_NNOISE_TH_SIZE                                       (1u)
#define CY_CAPSENSE_BUTTON2_NNOISE_TH_PARAM_ID                                   (0x050200a3u)

#define CY_CAPSENSE_BUTTON2_HYSTERESIS_VALUE                                     (cy_capsense_tuner.widgetContext[2].hysteresis)
#define CY_CAPSENSE_BUTTON2_HYSTERESIS_OFFSET                                    (164u)
#define CY_CAPSENSE_BUTTON2_HYSTERESIS_SIZE                                      (1u)
#define CY_CAPSENSE_BUTTON2_HYSTERESIS_PARAM_ID                                  (0x050200a4u)

#define CY_CAPSENSE_BUTTON2_ON_DEBOUNCE_VALUE                                    (cy_capsense_tuner.widgetContext[2].onDebounce)
#define CY_CAPSENSE_BUTTON2_ON_DEBOUNCE_OFFSET                                   (165u)
#define CY_CAPSENSE_BUTTON2_ON_DEBOUNCE_SIZE                                     (1u)
#define CY_CAPSENSE_BUTTON2_ON_DEBOUNCE_PARAM_ID                                 (0x050200a5u)

#define CY_CAPSENSE_BUTTON2_TX_CLK_SOURCE_VALUE                                  (cy_capsense_tuner.widgetContext[2].snsClkSource)
#define CY_CAPSENSE_BUTTON2_TX_CLK_SOURCE_OFFSET                                 (166u)
#define CY_CAPSENSE_BUTTON2_TX_CLK_SOURCE_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_TX_CLK_SOURCE_PARAM_ID                               (0x050200a6u)

#define CY_CAPSENSE_BUTTON2_IDAC_MOD0_VALUE                                      (cy_capsense_tuner.widgetContext[2].idacMod[0])
#define CY_CAPSENSE_BUTTON2_IDAC_MOD0_OFFSET                                     (167u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD0_SIZE                                       (1u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD0_PARAM_ID                                   (0x050200a7u)

#define CY_CAPSENSE_BUTTON2_IDAC_MOD1_VALUE                                      (cy_capsense_tuner.widgetContext[2].idacMod[1])
#define CY_CAPSENSE_BUTTON2_IDAC_MOD1_OFFSET                                     (168u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD1_SIZE                                       (1u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD1_PARAM_ID                                   (0x050200a8u)

#define CY_CAPSENSE_BUTTON2_IDAC_MOD2_VALUE                                      (cy_capsense_tuner.widgetContext[2].idacMod[2])
#define CY_CAPSENSE_BUTTON2_IDAC_MOD2_OFFSET                                     (169u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD2_SIZE                                       (1u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD2_PARAM_ID                                   (0x050200a9u)

#define CY_CAPSENSE_BUTTON2_IDAC_GAIN_INDEX_VALUE                                (cy_capsense_tuner.widgetContext[2].idacGainIndex)
#define CY_CAPSENSE_BUTTON2_IDAC_GAIN_INDEX_OFFSET                               (170u)
#define CY_CAPSENSE_BUTTON2_IDAC_GAIN_INDEX_SIZE                                 (1u)
#define CY_CAPSENSE_BUTTON2_IDAC_GAIN_INDEX_PARAM_ID                             (0x050200aau)

#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD0_VALUE                                  (cy_capsense_tuner.widgetContext[2].rowIdacMod[0])
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD0_OFFSET                                 (171u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD0_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD0_PARAM_ID                               (0x050200abu)

#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD1_VALUE                                  (cy_capsense_tuner.widgetContext[2].rowIdacMod[1])
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD1_OFFSET                                 (172u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD1_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD1_PARAM_ID                               (0x050200acu)

#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD2_VALUE                                  (cy_capsense_tuner.widgetContext[2].rowIdacMod[2])
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD2_OFFSET                                 (173u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD2_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD2_PARAM_ID                               (0x050200adu)

#define CY_CAPSENSE_BUTTON2_REGULAR_IIR_BL_N_VALUE                               (cy_capsense_tuner.widgetContext[2].bslnCoeff)
#define CY_CAPSENSE_BUTTON2_REGULAR_IIR_BL_N_OFFSET                              (174u)
#define CY_CAPSENSE_BUTTON2_REGULAR_IIR_BL_N_SIZE                                (1u)
#define CY_CAPSENSE_BUTTON2_REGULAR_IIR_BL_N_PARAM_ID                            (0x010200aeu)

#define CY_CAPSENSE_BUTTON2_STATUS_VALUE                                         (cy_capsense_tuner.widgetContext[2].status)
#define CY_CAPSENSE_BUTTON2_STATUS_OFFSET                                        (175u)
#define CY_CAPSENSE_BUTTON2_STATUS_SIZE                                          (1u)
#define CY_CAPSENSE_BUTTON2_STATUS_PARAM_ID                                      (0x010200afu)

#define CY_CAPSENSE_BUTTON2_PTRPOSITION_VALUE                                    (cy_capsense_tuner.widgetContext[2].wdTouch.ptrPosition)
#define CY_CAPSENSE_BUTTON2_PTRPOSITION_OFFSET                                   (176u)
#define CY_CAPSENSE_BUTTON2_PTRPOSITION_SIZE                                     (4u)
#define CY_CAPSENSE_BUTTON2_PTRPOSITION_PARAM_ID                                 (0x030200b0u)

#define CY_CAPSENSE_BUTTON2_NUM_POSITIONS_VALUE                                  (cy_capsense_tuner.widgetContext[2].wdTouch.numPosition)
#define CY_CAPSENSE_BUTTON2_NUM_POSITIONS_OFFSET                                 (180u)
#define CY_CAPSENSE_BUTTON2_NUM_POSITIONS_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_NUM_POSITIONS_PARAM_ID                               (0x010200b4u)

#define CY_CAPSENSE_LINEARSLIDER0_FINGER_CP_VALUE                                (cy_capsense_tuner.widgetContext[3].fingerCap)
#define CY_CAPSENSE_LINEARSLIDER0_FINGER_CP_OFFSET                               (184u)
#define CY_CAPSENSE_LINEARSLIDER0_FINGER_CP_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_FINGER_CP_PARAM_ID                             (0x060300b8u)

#define CY_CAPSENSE_LINEARSLIDER0_SIGPFC_VALUE                                   (cy_capsense_tuner.widgetContext[3].sigPFC)
#define CY_CAPSENSE_LINEARSLIDER0_SIGPFC_OFFSET                                  (186u)
#define CY_CAPSENSE_LINEARSLIDER0_SIGPFC_SIZE                                    (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SIGPFC_PARAM_ID                                (0x060300bau)

#define CY_CAPSENSE_LINEARSLIDER0_RESOLUTION_VALUE                               (cy_capsense_tuner.widgetContext[3].resolution)
#define CY_CAPSENSE_LINEARSLIDER0_RESOLUTION_OFFSET                              (188u)
#define CY_CAPSENSE_LINEARSLIDER0_RESOLUTION_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_RESOLUTION_PARAM_ID                            (0x060300bcu)

#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNT_VALUE                              (cy_capsense_tuner.widgetContext[3].maxRawCount)
#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNT_OFFSET                             (190u)
#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNT_SIZE                               (2u)
#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNT_PARAM_ID                           (0x020300beu)

#define CY_CAPSENSE_LINEARSLIDER0_FINGER_TH_VALUE                                (cy_capsense_tuner.widgetContext[3].fingerTh)
#define CY_CAPSENSE_LINEARSLIDER0_FINGER_TH_OFFSET                               (192u)
#define CY_CAPSENSE_LINEARSLIDER0_FINGER_TH_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_FINGER_TH_PARAM_ID                             (0x060300c0u)

#define CY_CAPSENSE_LINEARSLIDER0_PROX_TOUCH_TH_VALUE                            (cy_capsense_tuner.widgetContext[3].proxTh)
#define CY_CAPSENSE_LINEARSLIDER0_PROX_TOUCH_TH_OFFSET                           (194u)
#define CY_CAPSENSE_LINEARSLIDER0_PROX_TOUCH_TH_SIZE                             (2u)
#define CY_CAPSENSE_LINEARSLIDER0_PROX_TOUCH_TH_PARAM_ID                         (0x060300c2u)

#define CY_CAPSENSE_LINEARSLIDER0_LOW_BSLN_RST_VALUE                             (cy_capsense_tuner.widgetContext[3].lowBslnRst)
#define CY_CAPSENSE_LINEARSLIDER0_LOW_BSLN_RST_OFFSET                            (196u)
#define CY_CAPSENSE_LINEARSLIDER0_LOW_BSLN_RST_SIZE                              (2u)
#define CY_CAPSENSE_LINEARSLIDER0_LOW_BSLN_RST_PARAM_ID                          (0x060300c4u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_VALUE                                  (cy_capsense_tuner.widgetContext[3].snsClk)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_OFFSET                                 (198u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SIZE                                   (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_PARAM_ID                               (0x060300c6u)

#define CY_CAPSENSE_LINEARSLIDER0_ROW_SNS_CLK_VALUE                              (cy_capsense_tuner.widgetContext[3].rowSnsClk)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_SNS_CLK_OFFSET                             (200u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_SNS_CLK_SIZE                               (2u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_SNS_CLK_PARAM_ID                           (0x060300c8u)

#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DETECTED_VALUE                         (cy_capsense_tuner.widgetContext[3].gestureDetected)
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DETECTED_OFFSET                        (202u)
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DETECTED_SIZE                          (2u)
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DETECTED_PARAM_ID                      (0x020300cau)
...
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DIRECTION_PARAM_ID                     (0x020300ccu)

#define CY_CAPSENSE_LINEARSLIDER0_XDELTA_VALUE                                   (cy_capsense_tuner.widgetContext[3].xDelta)
#define CY_CAPSENSE_LINEARSLIDER0_XDELTA_OFFSET                                  (206u)
#define CY_CAPSENSE_LINEARSLIDER0_XDELTA_SIZE                                    (2u)
#define CY_CAPSENSE_LINEARSLIDER0_XDELTA_PARAM_ID                                (0x020300ceu)

#define CY_CAPSENSE_LINEARSLIDER0_YDELTA_VALUE                                   (cy_capsense_tuner.widgetContext[3].yDelta)
#define CY_CAPSENSE_LINEARSLIDER0_YDELTA_OFFSET                                  (208u)
#define CY_CAPSENSE_LINEARSLIDER0_YDELTA_SIZE                                    (2u)
#define CY_CAPSENSE_LINEARSLIDER0_YDELTA_PARAM_ID                                (0x020300d0u)

#define CY_CAPSENSE_LINEARSLIDER0_NOISE_TH_VALUE                                 (cy_capsense_tuner.widgetContext[3].noiseTh)
#define CY_CAPSENSE_LINEARSLIDER0_NOISE_TH_OFFSET                                (210u)
#define CY_CAPSENSE_LINEARSLIDER0_NOISE_TH_SIZE                                  (1u)
#define CY_CAPSENSE_LINEARSLIDER0_NOISE_TH_PARAM_ID                              (0x050300d2u)

#define CY_CAPSENSE_LINEARSLIDER0_NNOISE_TH_VALUE                                (cy_capsense_tuner.widgetContext[3].nNoiseTh)
#define CY_CAPSENSE_LINEARSLIDER0_NNOISE_TH_OFFSET                               (211u)
#define CY_CAPSENSE_LINEARSLIDER0_NNOISE_TH_SIZE                                 (1u)
#define CY_CAPSENSE_LINEARSLIDER0_NNOISE_TH_PARAM_ID                             (0x050300d3u)

#define CY_CAPSENSE_LINEARSLIDER0_HYSTERESIS_VALUE                               (cy_capsense_tuner.widgetContext[3].hysteresis)
#define CY_CAPSENSE_LINEARSLIDER0_HYSTERESIS_OFFSET                              (212u)
#define CY_CAPSENSE_LINEARSLIDER0_HYSTERESIS_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_HYSTERESIS_PARAM_ID                            (0x050300d4u)

#define CY_CAPSENSE_LINEARSLIDER0_ON_DEBOUNCE_VALUE                              (cy_capsense_tuner.widgetContext[3].onDebounce)
#define CY_CAPSENSE_LINEARSLIDER0_ON_DEBOUNCE_OFFSET                             (213u)
#define CY_CAPSENSE_LINEARSLIDER0_ON_DEBOUNCE_SIZE                               (1u)
#define CY_CAPSENSE_LINEARSLIDER0_ON_DEBOUNCE_PARAM_ID                           (0x050300d5u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SOURCE_VALUE                           (cy_capsense_tuner.widgetContext[3].snsClkSource)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SOURCE_OFFSET                          (214u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SOURCE_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SOURCE_PARAM_ID                        (0x050300d6u)

#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD0_VALUE                                (cy_capsense_tuner.widgetContext[3].idacMod[0])
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD0_OFFSET                               (215u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD0_SIZE                                 (1u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD0_PARAM_ID                             (0x050300d7u)

#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD1_VALUE                                (cy_capsense_tuner.widgetContext[3].idacMod[1])
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD1_OFFSET                               (216u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD1_SIZE                                 (1u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD1_PARAM_ID                             (0x050300d8u)

#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD2_VALUE                                (cy_capsense_tuner.widgetContext[3].idacMod[2])
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD2_OFFSET                               (217u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD2_SIZE                                 (1u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD2_PARAM_ID                             (0x050300d9u)

#define CY_CAPSENSE_LINEARSLIDER0_IDAC_GAIN_INDEX_VALUE                          (cy_capsense_tuner.widgetContext[3].idacGainIndex)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_GAIN_INDEX_OFFSET                         (218u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_GAIN_INDEX_SIZE                           (1u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_GAIN_INDEX_PARAM_ID                       (0x050300dau)

#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD0_VALUE                            (cy_capsense_tuner.widgetContext[3].rowIdacMod[0])
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD0_OFFSET                           (219u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD0_SIZE                             (1u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD0_PARAM_ID                         (0x050300dbu)

#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD1_VALUE                            (cy_capsense_tuner.widgetContext[3].rowIdacMod[1])
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD1_OFFSET                           (220u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD1_SIZE                             (1u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD1_PARAM_ID                         (0x050300dcu)

#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD2_VALUE                            (cy_capsense_tuner.widgetContext[3].rowIdacMod[2])
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD2_OFFSET                           (221u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD2_SIZE                             (1u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD2_PARAM_ID                         (0x050300ddu)

#define CY_CAPSENSE_LINEARSLIDER0_REGULAR_IIR_BL_N_VALUE                         (cy_capsense_tuner.widgetContext[3].bslnCoeff)
#define CY_CAPSENSE_LINEARSLIDER0_REGULAR_IIR_BL_N_OFFSET                        (222u)
#define CY_CAPSENSE_LINEARSLIDER0_REGULAR_IIR_BL_N_SIZE                          (1u)
#define CY_CAPSENSE_LINEARSLIDER0_REGULAR_IIR_BL_N_PARAM_ID                      (0x010300deu)

#define CY_CAPSENSE_LINEARSLIDER0_STATUS_VALUE                                   (cy_capsense_tuner.widgetContext[3].status)
#define CY_CAPSENSE_LINEARSLIDER0_STATUS_OFFSET                                  (223u)
#define CY_CAPSENSE_LINEARSLIDER0_STATUS_SIZE                                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_STATUS_PARAM_ID                                (0x010300dfu)

#define CY_CAPSENSE_LINEARSLIDER0_PTRPOSITION_VALUE                              (cy_capsense_tuner.widgetContext[3].wdTouch.ptrPosition)
#define CY_CAPSENSE_LINEARSLIDER0_PTRPOSITION_OFFSET                             (224u)
#define CY_CAPSENSE_LINEARSLIDER0_PTRPOSITION_SIZE                               (4u)
#define CY_CAPSENSE_LINEARSLIDER0_PTRPOSITION_PARAM_ID                           (0x030300e0u)

#define CY_CAPSENSE_LINEARSLIDER0_NUM_POSITIONS_VALUE                            (cy_capsense_tuner.widgetContext[3].wdTouch.numPosition)
#define CY_CAPSENSE_LINEARSLIDER0_NUM_POSITIONS_OFFSET                           (228u)
#define CY_CAPSENSE_LINEARSLIDER0_NUM_POSITIONS_SIZE                             (1u)
#define CY_CAPSENSE_LINEARSLIDER0_NUM_POSITIONS_PARAM_ID                         (0x010300e4u)
...
#define CY_CAPSENSE_BUTTON2_RX0_RAW0_VALUE                                       (cy_capsense_tuner.sensorContext[2].raw)
#define CY_CAPSENSE_BUTTON2_RX0_RAW0_OFFSET                                      (252u)
#define CY_CAPSENSE_BUTTON2_RX0_RAW0_SIZE                                        (2u)
#define CY_CAPSENSE_BUTTON2_RX0_RAW0_PARAM_ID                                    (0x020200fcu)

#define CY_CAPSENSE_BUTTON2_RX0_BSLN0_VALUE                                      (cy_capsense_tuner.sensorContext[2].bsln)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN0_OFFSET                                     (254u)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN0_SIZE                                       (2u)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN0_PARAM_ID                                   (0x020200feu)

#define CY_CAPSENSE_BUTTON2_RX0_DIFF0_VALUE                                      (cy_capsense_tuner.sensorContext[2].diff)
#define CY_CAPSENSE_BUTTON2_RX0_DIFF0_OFFSET                                     (256u)
#define CY_CAPSENSE_BUTTON2_RX0_DIFF0_SIZE                                       (2u)
#define CY_CAPSENSE_BUTTON2_RX0_DIFF0_PARAM_ID                                   (0x02020100u)

#define CY_CAPSENSE_BUTTON2_RX0_STATUS0_VALUE                                    (cy_capsense_tuner.sensorContext[2].status)
#define CY_CAPSENSE_BUTTON2_RX0_STATUS0_OFFSET                                   (258u)
#define CY_CAPSENSE_BUTTON2_RX0_STATUS0_SIZE                                     (1u)
#define CY_CAPSENSE_BUTTON2_RX0_STATUS0_PARAM_ID                                 (0x01020102u)

#define CY_CAPSENSE_BUTTON2_RX0_NEG_BSLN_RST_CNT0_VALUE                          (cy_capsense_tuner.sensorContext[2].negBslnRstCnt)
#define CY_CAPSENSE_BUTTON2_RX0_NEG_BSLN_RST_CNT0_OFFSET                         (259u)
#define CY_CAPSENSE_BUTTON2_RX0_NEG_BSLN_RST_CNT0_SIZE                           (1u)
#define CY_CAPSENSE_BUTTON2_RX0_NEG_BSLN_RST_CNT0_PARAM_ID                       (0x01020103u)

#define CY_CAPSENSE_BUTTON2_RX0_IDAC0_VALUE                                      (cy_capsense_tuner.sensorContext[2].idacComp)
#define CY_CAPSENSE_BUTTON2_RX0_IDAC0_OFFSET                                     (260u)
#define CY_CAPSENSE_BUTTON2_RX0_IDAC0_SIZE                                       (1u)
#define CY_CAPSENSE_BUTTON2_RX0_IDAC0_PARAM_ID                                   (0x01020104u)

#define CY_CAPSENSE_BUTTON2_RX0_BSLN_EXT0_VALUE                                  (cy_capsense_tuner.sensorContext[2].bslnExt)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN_EXT0_OFFSET                                 (261u)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN_EXT0_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN_EXT0_PARAM_ID                               (0x01020105u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[3].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_RAW0_OFFSET                               (262u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_RAW0_PARAM_ID                             (0x02030106u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[3].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN0_OFFSET                              (264u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN0_PARAM_ID                            (0x02030108u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[3].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_DIFF0_OFFSET                              (266u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_DIFF0_PARAM_ID                            (0x0203010au)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[3].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_STATUS0_OFFSET                            (268u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_STATUS0_PARAM_ID                          (0x0103010cu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[3].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_NEG_BSLN_RST_CNT0_OFFSET                  (269u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_NEG_BSLN_RST_CNT0_PARAM_ID                (0x0103010du)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[3].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_IDAC0_OFFSET                              (270u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_IDAC0_PARAM_ID                            (0x0103010eu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[3].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN_EXT0_OFFSET                          (271u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN_EXT0_PARAM_ID                        (0x0103010fu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[4].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_RAW0_OFFSET                               (272u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_RAW0_PARAM_ID                             (0x02030110u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[4].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN0_OFFSET                              (274u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN0_PARAM_ID                            (0x02030112u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[4].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_DIFF0_OFFSET                              (276u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_DIFF0_PARAM_ID                            (0x02030114u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[4].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_STATUS0_OFFSET                            (278u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_STATUS0_PARAM_ID                          (0x01030116u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[4].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_NEG_BSLN_RST_CNT0_OFFSET                  (279u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_NEG_BSLN_RST_CNT0_PARAM_ID                (0x01030117u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[4].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_IDAC0_OFFSET                              (280u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_IDAC0_PARAM_ID                            (0x01030118u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[4].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN_EXT0_OFFSET                          (281u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN_EXT0_PARAM_ID                        (0x01030119u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[5].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_RAW0_OFFSET                               (282u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_RAW0_PARAM_ID                             (0x0203011au)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[5].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN0_OFFSET                              (284u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN0_PARAM_ID                            (0x0203011cu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[5].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_DIFF0_OFFSET                              (286u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_DIFF0_PARAM_ID                            (0x0203011eu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[5].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_STATUS0_OFFSET                            (288u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_STATUS0_PARAM_ID                          (0x01030120u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[5].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_NEG_BSLN_RST_CNT0_OFFSET                  (289u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_NEG_BSLN_RST_CNT0_PARAM_ID                (0x01030121u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[5].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_IDAC0_OFFSET                              (290u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_IDAC0_PARAM_ID                            (0x01030122u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[5].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN_EXT0_OFFSET                          (291u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN_EXT0_PARAM_ID                        (0x01030123u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[6].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_RAW0_OFFSET                               (292u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_RAW0_PARAM_ID                             (0x02030124u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[6].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN0_OFFSET                              (294u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN0_PARAM_ID                            (0x02030126u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[6].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_DIFF0_OFFSET                              (296u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_DIFF0_PARAM_ID                            (0x02030128u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[6].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_STATUS0_OFFSET                            (298u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_STATUS0_PARAM_ID                          (0x0103012au)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[6].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_NEG_BSLN_RST_CNT0_OFFSET                  (299u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_NEG_BSLN_RST_CNT0_PARAM_ID                (0x0103012bu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[6].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_IDAC0_OFFSET                              (300u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_IDAC0_PARAM_ID                            (0x0103012cu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[6].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN_EXT0_OFFSET                          (301u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN_EXT0_PARAM_ID                        (0x0103012du)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[7].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_RAW0_OFFSET                               (302u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_RAW0_PARAM_ID                             (0x0203012eu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[7].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN0_OFFSET                              (304u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN0_PARAM_ID                            (0x02030130u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[7].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_DIFF0_OFFSET                              (306u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_DIFF0_PARAM_ID                            (0x02030132u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[7].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_STATUS0_OFFSET                            (308u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_STATUS0_PARAM_ID                          (0x01030134u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[7].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_NEG_BSLN_RST_CNT0_OFFSET                  (309u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_NEG_BSLN_RST_CNT0_PARAM_ID                (0x01030135u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[7].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_IDAC0_OFFSET                              (310u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_IDAC0_PARAM_ID                            (0x01030136u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[7].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN_EXT0_OFFSET                          (311u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN_EXT0_PARAM_ID                        (0x01030137u)

#define CY_CAPSENSE_LINEARSLIDER0_X0_VALUE                                       (cy_capsense_tuner.position[0].x)
#define CY_CAPSENSE_LINEARSLIDER0_X0_OFFSET                                      (312u)
#define CY_CAPSENSE_LINEARSLIDER0_X0_SIZE                                        (2u)
#define CY_CAPSENSE_LINEARSLIDER0_X0_PARAM_ID                                    (0x02030138u)

#define CY_CAPSENSE_LINEARSLIDER0_Y0_VALUE                                       (cy_capsense_tuner.position[0].y)
#define CY_CAPSENSE_LINEARSLIDER0_Y0_OFFSET                                      (314u)
#define CY_CAPSENSE_LINEARSLIDER0_Y0_SIZE                                        (2u)
#define CY_CAPSENSE_LINEARSLIDER0_Y0_PARAM_ID                                    (0x0203013au)

#define CY_CAPSENSE_LINEARSLIDER0_Z0_VALUE                                       (cy_capsense_tuner.position[0].z)
#define CY_CAPSENSE_LINEARSLIDER0_Z0_OFFSET                                      (316u)
#define CY_CAPSENSE_LINEARSLIDER0_Z0_SIZE                                        (2u)
#define CY_CAPSENSE_LINEARSLIDER0_Z0_PARAM_ID                                    (0x0203013cu)

#define CY_CAPSENSE_LINEARSLIDER0_ID0_VALUE                                      (cy_capsense_tuner.position[0].id)
#define CY_CAPSENSE_LINEARSLIDER0_ID0_OFFSET                                     (318u)
#define CY_CAPSENSE_LINEARSLIDER0_ID0_SIZE                                       (2u)
#define CY_CAPSENSE_LINEARSLIDER0_ID0_PARAM_ID                                   (0x0203013eu)
...
#define CY_CAPSENSE_BUTTON2_MAXRAWCOUNTROW_VALUE                                 (cy_capsense_tuner.widgetContext[2].maxRawCountRow)
#define CY_CAPSENSE_BUTTON2_MAXRAWCOUNTROW_OFFSET                                (144u)
#define CY_CAPSENSE_BUTTON2_MAXRAWCOUNTROW_SIZE                                  (2u)
#define CY_CAPSENSE_BUTTON2_MAXRAWCOUNTROW_PARAM_ID                              (0x02020090u)

#define CY_CAPSENSE_BUTTON2_FINGER_TH_VALUE                                      (cy_capsense_tuner.widgetContext[2].fingerTh)
#define CY_CAPSENSE_BUTTON2_FINGER_TH_OFFSET                                     (146u)
#define CY_CAPSENSE_BUTTON2_FINGER_TH_SIZE                                       (2u)
#define CY_CAPSENSE_BUTTON2_FINGER_TH_PARAM_ID                                   (0x06020092u)

#define CY_CAPSENSE_BUTTON2_PROX_TOUCH_TH_VALUE                                  (cy_capsense_tuner.widgetContext[2].proxTh)
#define CY_CAPSENSE_BUTTON2_PROX_TOUCH_TH_OFFSET                                 (148u)
#define CY_CAPSENSE_BUTTON2_PROX_TOUCH_TH_SIZE                                   (2u)
#define CY_CAPSENSE_BUTTON2_PROX_TOUCH_TH_PARAM_ID                               (0x06020094u)

#define CY_CAPSENSE_BUTTON2_LOW_BSLN_RST_VALUE                                   (cy_capsense_tuner.widgetContext[2].lowBslnRst)
#define CY_CAPSENSE_BUTTON2_LOW_BSLN_RST_OFFSET                                  (150u)
#define CY_CAPSENSE_BUTTON2_LOW_BSLN_RST_SIZE                                    (2u)
#define CY_CAPSENSE_BUTTON2_LOW_BSLN_RST_PARAM_ID                                (0x06020096u)

#define CY_CAPSENSE_BUTTON2_TX_CLK_VALUE                                         (cy_capsense_tuner.widgetContext[2].snsClk)
#define CY_CAPSENSE_BUTTON2_TX_CLK_OFFSET                                        (152u)
#define CY_CAPSENSE_BUTTON2_TX_CLK_SIZE                                          (2u)
#define CY_CAPSENSE_BUTTON2_TX_CLK_PARAM_ID                                      (0x06020098u)

#define CY_CAPSENSE_BUTTON2_ROW_SNS_CLK_VALUE                                    (cy_capsense_tuner.widgetContext[2].rowSnsClk)
#define CY_CAPSENSE_BUTTON2_ROW_SNS_CLK_OFFSET                                   (154u)
#define CY_CAPSENSE_BUTTON2_ROW_SNS_CLK_SIZE                                     (2u)
#define CY_CAPSENSE_BUTTON2_ROW_SNS_CLK_PARAM_ID                                 (0x0602009au)

#define CY_CAPSENSE_BUTTON2_GESTURE_DETECTED_VALUE                               (cy_capsense_tuner.widgetContext[2].gestureDetected)
#define CY_CAPSENSE_BUTTON2_GESTURE_DETECTED_OFFSET                              (156u)
#define CY_CAPSENSE_BUTTON2_GESTURE_DETECTED_SIZE                                (2u)
#define CY_CAPSENSE_BUTTON2_GESTURE_DETECTED_PARAM_ID                            (0x0202009cu)

#define CY_CAPSENSE_BUTTON2_GESTURE_DIRECTION_VALUE                              (cy_capsense_tuner.widgetContext[2].gestureDirection)
#define CY_CAPSENSE_BUTTON2_GESTURE_DIRECTION_OFFSET                             (158u)
#define CY_CAPSENSE_BUTTON2_GESTURE_DIRECTION_SIZE                               (2u)
#define CY_CAPSENSE_BUTTON2_GESTURE_DIRECTION_PARAM_ID                           (0x0202009eu)

#define CY_CAPSENSE_BUTTON2_XDELTA_VALUE                                         (cy_capsense_tuner.widgetContext[2].xDelta)
#define CY_CAPSENSE_BUTTON2_XDELTA_OFFSET                                        (160u)
#define CY_CAPSENSE_BUTTON2_XDELTA_SIZE                                          (2u)
#define CY_CAPSENSE_BUTTON2_XDELTA_PARAM_ID                                      (0x020200a0u)

#define CY_CAPSENSE_BUTTON2_YDELTA_VALUE                                         (cy_capsense_tuner.widgetContext[2].yDelta)
#define CY_CAPSENSE_BUTTON2_YDELTA_OFFSET                                        (162u)
#define CY_CAPSENSE_BUTTON2_YDELTA_SIZE                                          (2u)
#define CY_CAPSENSE_BUTTON2_YDELTA_PARAM_ID                                      (0x020200a2u)

#define CY_CAPSENSE_BUTTON2_NOISE_TH_VALUE                                       (cy_capsense_tuner.widgetContext[2].noiseTh)
#define CY_CAPSENSE_BUTTON2_NOISE_TH_OFFSET                                      (164u)
#define CY_CAPSENSE_BUTTON2_NOISE_TH_SIZE                                        (2u)
#define CY_CAPSENSE_BUTTON2_NOISE_TH_PARAM_ID                                    (0x060200a4u)

#define CY_CAPSENSE_BUTTON2_NNOISE_TH_VALUE                                      (cy_capsense_tuner.widgetContext[2].nNoiseTh)
#define CY_CAPSENSE_BUTTON2_NNOISE_TH_OFFSET                                     (166u)
#define CY_CAPSENSE_BUTTON2_NNOISE_TH_SIZE                                       (2u)
#define CY_CAPSENSE_BUTTON2_NNOISE_TH_PARAM_ID                                   (0x060200a6u)

#define CY_CAPSENSE_BUTTON2_HYSTERESIS_VALUE                                     (cy_capsense_tuner.widgetContext[2].hysteresis)
#define CY_CAPSENSE_BUTTON2_HYSTERESIS_OFFSET                                    (168u)
#define CY_CAPSENSE_BUTTON2_HYSTERESIS_SIZE                                      (2u)
#define CY_CAPSENSE_BUTTON2_HYSTERESIS_PARAM_ID                                  (0x060200a8u)

#define CY_CAPSENSE_BUTTON2_ON_DEBOUNCE_VALUE                                    (cy_capsense_tuner.widgetContext[2].onDebounce)
#define CY_CAPSENSE_BUTTON2_ON_DEBOUNCE_OFFSET                                   (170u)
#define CY_CAPSENSE_BUTTON2_ON_DEBOUNCE_SIZE                                     (1u)
#define CY_CAPSENSE_BUTTON2_ON_DEBOUNCE_PARAM_ID                                 (0x050200aau)

#define CY_CAPSENSE_BUTTON2_TX_CLK_SOURCE_VALUE                                  (cy_capsense_tuner.widgetContext[2].snsClkSource)
#define CY_CAPSENSE_BUTTON2_TX_CLK_SOURCE_OFFSET                                 (171u)
#define CY_CAPSENSE_BUTTON2_TX_CLK_SOURCE_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_TX_CLK_SOURCE_PARAM_ID                               (0x050200abu)

#define CY_CAPSENSE_BUTTON2_IDAC_MOD0_VALUE                                      (cy_capsense_tuner.widgetContext[2].idacMod[0])
#define CY_CAPSENSE_BUTTON2_IDAC_MOD0_OFFSET                                     (172u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD0_SIZE                                       (1u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD0_PARAM_ID                                   (0x050200acu)

#define CY_CAPSENSE_BUTTON2_IDAC_MOD1_VALUE                                      (cy_capsense_tuner.widgetContext[2].idacMod[1])
#define CY_CAPSENSE_BUTTON2_IDAC_MOD1_OFFSET                                     (173u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD1_SIZE                                       (1u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD1_PARAM_ID                                   (0x050200adu)

#define CY_CAPSENSE_BUTTON2_IDAC_MOD2_VALUE                                      (cy_capsense_tuner.widgetContext[2].idacMod[2])
#define CY_CAPSENSE_BUTTON2_IDAC_MOD2_OFFSET                                     (174u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD2_SIZE                                       (1u)
#define CY_CAPSENSE_BUTTON2_IDAC_MOD2_PARAM_ID                                   (0x050200aeu)

#define CY_CAPSENSE_BUTTON2_IDAC_GAIN_INDEX_VALUE                                (cy_capsense_tuner.widgetContext[2].idacGainIndex)
#define CY_CAPSENSE_BUTTON2_IDAC_GAIN_INDEX_OFFSET                               (175u)
#define CY_CAPSENSE_BUTTON2_IDAC_GAIN_INDEX_SIZE                                 (1u)
#define CY_CAPSENSE_BUTTON2_IDAC_GAIN_INDEX_PARAM_ID                             (0x050200afu)

#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD0_VALUE                                  (cy_capsense_tuner.widgetContext[2].rowIdacMod[0])
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD0_OFFSET                                 (176u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD0_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD0_PARAM_ID                               (0x050200b0u)

#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD1_VALUE                                  (cy_capsense_tuner.widgetContext[2].rowIdacMod[1])
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD1_OFFSET                                 (177u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD1_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD1_PARAM_ID                               (0x050200b1u)

#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD2_VALUE                                  (cy_capsense_tuner.widgetContext[2].rowIdacMod[2])
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD2_OFFSET                                 (178u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD2_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_ROW_IDAC_MOD2_PARAM_ID                               (0x050200b2u)

#define CY_CAPSENSE_BUTTON2_REGULAR_IIR_BL_N_VALUE                               (cy_capsense_tuner.widgetContext[2].bslnCoeff)
#define CY_CAPSENSE_BUTTON2_REGULAR_IIR_BL_N_OFFSET                              (179u)
#define CY_CAPSENSE_BUTTON2_REGULAR_IIR_BL_N_SIZE                                (1u)
#define CY_CAPSENSE_BUTTON2_REGULAR_IIR_BL_N_PARAM_ID                            (0x010200b3u)

#define CY_CAPSENSE_BUTTON2_STATUS_VALUE                                         (cy_capsense_tuner.widgetContext[2].status)
#define CY_CAPSENSE_BUTTON2_STATUS_OFFSET                                        (180u)
#define CY_CAPSENSE_BUTTON2_STATUS_SIZE                                          (1u)
#define CY_CAPSENSE_BUTTON2_STATUS_PARAM_ID                                      (0x010200b4u)

#define CY_CAPSENSE_BUTTON2_PTRPOSITION_VALUE                                    (cy_capsense_tuner.widgetContext[2].wdTouch.ptrPosition)
#define CY_CAPSENSE_BUTTON2_PTRPOSITION_OFFSET                                   (184u)
#define CY_CAPSENSE_BUTTON2_PTRPOSITION_SIZE                                     (4u)
#define CY_CAPSENSE_BUTTON2_PTRPOSITION_PARAM_ID                                 (0x030200b8u)

#define CY_CAPSENSE_BUTTON2_NUM_POSITIONS_VALUE                                  (cy_capsense_tuner.widgetContext[2].wdTouch.numPosition)
#define CY_CAPSENSE_BUTTON2_NUM_POSITIONS_OFFSET                                 (188u)
#define CY_CAPSENSE_BUTTON2_NUM_POSITIONS_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_NUM_POSITIONS_PARAM_ID                               (0x010200bcu)
...
#define CY_CAPSENSE_LINEARSLIDER0_RESOLUTION_VALUE                               (cy_capsense_tuner.widgetContext[3].resolution)
#define CY_CAPSENSE_LINEARSLIDER0_RESOLUTION_OFFSET                              (196u)
#define CY_CAPSENSE_LINEARSLIDER0_RESOLUTION_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_RESOLUTION_PARAM_ID                            (0x060300c4u)

#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNT_VALUE                              (cy_capsense_tuner.widgetContext[3].maxRawCount)
#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNT_OFFSET                             (198u)
#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNT_SIZE                               (2u)
#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNT_PARAM_ID                           (0x020300c6u)

#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNTROW_VALUE                           (cy_capsense_tuner.widgetContext[3].maxRawCountRow)
#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNTROW_OFFSET                          (200u)
#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNTROW_SIZE                            (2u)
#define CY_CAPSENSE_LINEARSLIDER0_MAXRAWCOUNTROW_PARAM_ID                        (0x020300c8u)

#define CY_CAPSENSE_LINEARSLIDER0_FINGER_TH_VALUE                                (cy_capsense_tuner.widgetContext[3].fingerTh)
#define CY_CAPSENSE_LINEARSLIDER0_FINGER_TH_OFFSET                               (202u)
#define CY_CAPSENSE_LINEARSLIDER0_FINGER_TH_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_FINGER_TH_PARAM_ID                             (0x060300cau)

#define CY_CAPSENSE_LINEARSLIDER0_PROX_TOUCH_TH_VALUE                            (cy_capsense_tuner.widgetContext[3].proxTh)
#define CY_CAPSENSE_LINEARSLIDER0_PROX_TOUCH_TH_OFFSET                           (204u)
#define CY_CAPSENSE_LINEARSLIDER0_PROX_TOUCH_TH_SIZE                             (2u)
#define CY_CAPSENSE_LINEARSLIDER0_PROX_TOUCH_TH_PARAM_ID                         (0x060300ccu)

#define CY_CAPSENSE_LINEARSLIDER0_LOW_BSLN_RST_VALUE                             (cy_capsense_tuner.widgetContext[3].lowBslnRst)
#define CY_CAPSENSE_LINEARSLIDER0_LOW_BSLN_RST_OFFSET                            (206u)
#define CY_CAPSENSE_LINEARSLIDER0_LOW_BSLN_RST_SIZE                              (2u)
#define CY_CAPSENSE_LINEARSLIDER0_LOW_BSLN_RST_PARAM_ID                          (0x060300ceu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_VALUE                                  (cy_capsense_tuner.widgetContext[3].snsClk)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_OFFSET                                 (208u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SIZE                                   (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_PARAM_ID                               (0x060300d0u)

#define CY_CAPSENSE_LINEARSLIDER0_ROW_SNS_CLK_VALUE                              (cy_capsense_tuner.widgetContext[3].rowSnsClk)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_SNS_CLK_OFFSET                             (210u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_SNS_CLK_SIZE                               (2u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_SNS_CLK_PARAM_ID                           (0x060300d2u)

#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DETECTED_VALUE                         (cy_capsense_tuner.widgetContext[3].gestureDetected)
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DETECTED_OFFSET                        (212u)
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DETECTED_SIZE                          (2u)
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DETECTED_PARAM_ID                      (0x020300d4u)

#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DIRECTION_VALUE                        (cy_capsense_tuner.widgetContext[3].gestureDirection)
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DIRECTION_OFFSET                       (214u)
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DIRECTION_SIZE                         (2u)
#define CY_CAPSENSE_LINEARSLIDER0_GESTURE_DIRECTION_PARAM_ID                     (0x020300d6u)

#define CY_CAPSENSE_LINEARSLIDER0_XDELTA_VALUE                                   (cy_capsense_tuner.widgetContext[3].xDelta)
#define CY_CAPSENSE_LINEARSLIDER0_XDELTA_OFFSET                                  (216u)
#define CY_CAPSENSE_LINEARSLIDER0_XDELTA_SIZE                                    (2u)
#define CY_CAPSENSE_LINEARSLIDER0_XDELTA_PARAM_ID                                (0x020300d8u)

#define CY_CAPSENSE_LINEARSLIDER0_YDELTA_VALUE                                   (cy_capsense_tuner.widgetContext[3].yDelta)
#define CY_CAPSENSE_LINEARSLIDER0_YDELTA_OFFSET                                  (218u)
#define CY_CAPSENSE_LINEARSLIDER0_YDELTA_SIZE                                    (2u)
#define CY_CAPSENSE_LINEARSLIDER0_YDELTA_PARAM_ID                                (0x020300dau)

#define CY_CAPSENSE_LINEARSLIDER0_NOISE_TH_VALUE                                 (cy_capsense_tuner.widgetContext[3].noiseTh)
#define CY_CAPSENSE_LINEARSLIDER0_NOISE_TH_OFFSET                                (220u)
#define CY_CAPSENSE_LINEARSLIDER0_NOISE_TH_SIZE                                  (2u)
#define CY_CAPSENSE_LINEARSLIDER0_NOISE_TH_PARAM_ID                              (0x060300dcu)

#define CY_CAPSENSE_LINEARSLIDER0_NNOISE_TH_VALUE                                (cy_capsense_tuner.widgetContext[3].nNoiseTh)
#define CY_CAPSENSE_LINEARSLIDER0_NNOISE_TH_OFFSET                               (222u)
#define CY_CAPSENSE_LINEARSLIDER0_NNOISE_TH_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_NNOISE_TH_PARAM_ID                             (0x060300deu)

#define CY_CAPSENSE_LINEARSLIDER0_HYSTERESIS_VALUE                               (cy_capsense_tuner.widgetContext[3].hysteresis)
#define CY_CAPSENSE_LINEARSLIDER0_HYSTERESIS_OFFSET                              (224u)
#define CY_CAPSENSE_LINEARSLIDER0_HYSTERESIS_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_HYSTERESIS_PARAM_ID                            (0x060300e0u)

#define CY_CAPSENSE_LINEARSLIDER0_ON_DEBOUNCE_VALUE                              (cy_capsense_tuner.widgetContext[3].onDebounce)
#define CY_CAPSENSE_LINEARSLIDER0_ON_DEBOUNCE_OFFSET                             (226u)
#define CY_CAPSENSE_LINEARSLIDER0_ON_DEBOUNCE_SIZE                               (1u)
#define CY_CAPSENSE_LINEARSLIDER0_ON_DEBOUNCE_PARAM_ID                           (0x050300e2u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SOURCE_VALUE                           (cy_capsense_tuner.widgetContext[3].snsClkSource)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SOURCE_OFFSET                          (227u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SOURCE_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS_CLK_SOURCE_PARAM_ID                        (0x050300e3u)

#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD0_VALUE                                (cy_capsense_tuner.widgetContext[3].idacMod[0])
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD0_OFFSET                               (228u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD0_SIZE                                 (1u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD0_PARAM_ID                             (0x050300e4u)

#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD1_VALUE                                (cy_capsense_tuner.widgetContext[3].idacMod[1])
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD1_OFFSET                               (229u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD1_SIZE                                 (1u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD1_PARAM_ID                             (0x050300e5u)

#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD2_VALUE                                (cy_capsense_tuner.widgetContext[3].idacMod[2])
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD2_OFFSET                               (230u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD2_SIZE                                 (1u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_MOD2_PARAM_ID                             (0x050300e6u)

#define CY_CAPSENSE_LINEARSLIDER0_IDAC_GAIN_INDEX_VALUE                          (cy_capsense_tuner.widgetContext[3].idacGainIndex)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_GAIN_INDEX_OFFSET                         (231u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_GAIN_INDEX_SIZE                           (1u)
#define CY_CAPSENSE_LINEARSLIDER0_IDAC_GAIN_INDEX_PARAM_ID                       (0x050300e7u)

#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD0_VALUE                            (cy_capsense_tuner.widgetContext[3].rowIdacMod[0])
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD0_OFFSET                           (232u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD0_SIZE                             (1u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD0_PARAM_ID                         (0x050300e8u)

#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD1_VALUE                            (cy_capsense_tuner.widgetContext[3].rowIdacMod[1])
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD1_OFFSET                           (233u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD1_SIZE                             (1u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD1_PARAM_ID                         (0x050300e9u)

#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD2_VALUE                            (cy_capsense_tuner.widgetContext[3].rowIdacMod[2])
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD2_OFFSET                           (234u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD2_SIZE                             (1u)
#define CY_CAPSENSE_LINEARSLIDER0_ROW_IDAC_MOD2_PARAM_ID                         (0x050300eau)

#define CY_CAPSENSE_LINEARSLIDER0_REGULAR_IIR_BL_N_VALUE                         (cy_capsense_tuner.widgetContext[3].bslnCoeff)
#define CY_CAPSENSE_LINEARSLIDER0_REGULAR_IIR_BL_N_OFFSET                        (235u)
#define CY_CAPSENSE_LINEARSLIDER0_REGULAR_IIR_BL_N_SIZE                          (1u)
#define CY_CAPSENSE_LINEARSLIDER0_REGULAR_IIR_BL_N_PARAM_ID                      (0x010300ebu)

#define CY_CAPSENSE_LINEARSLIDER0_STATUS_VALUE                                   (cy_capsense_tuner.widgetContext[3].status)
#define CY_CAPSENSE_LINEARSLIDER0_STATUS_OFFSET                                  (236u)
#define CY_CAPSENSE_LINEARSLIDER0_STATUS_SIZE                                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_STATUS_PARAM_ID                                (0x010300ecu)

#define CY_CAPSENSE_LINEARSLIDER0_PTRPOSITION_VALUE                              (cy_capsense_tuner.widgetContext[3].wdTouch.ptrPosition)
#define CY_CAPSENSE_LINEARSLIDER0_PTRPOSITION_OFFSET                             (240u)
#define CY_CAPSENSE_LINEARSLIDER0_PTRPOSITION_SIZE                               (4u)
#define CY_CAPSENSE_LINEARSLIDER0_PTRPOSITION_PARAM_ID                           (0x030300f0u)

#define CY_CAPSENSE_LINEARSLIDER0_NUM_POSITIONS_VALUE                            (cy_capsense_tuner.widgetContext[3].wdTouch.numPosition)
#define CY_CAPSENSE_LINEARSLIDER0_NUM_POSITIONS_OFFSET                           (244u)
#define CY_CAPSENSE_LINEARSLIDER0_NUM_POSITIONS_SIZE                             (1u)
#define CY_CAPSENSE_LINEARSLIDER0_NUM_POSITIONS_PARAM_ID                         (0x010300f4u)
...
#define CY_CAPSENSE_BUTTON2_RX0_RAW0_VALUE                                       (cy_capsense_tuner.sensorContext[2].raw)
#define CY_CAPSENSE_BUTTON2_RX0_RAW0_OFFSET                                      (268u)
#define CY_CAPSENSE_BUTTON2_RX0_RAW0_SIZE                                        (2u)
#define CY_CAPSENSE_BUTTON2_RX0_RAW0_PARAM_ID                                    (0x0202010cu)

#define CY_CAPSENSE_BUTTON2_RX0_BSLN0_VALUE                                      (cy_capsense_tuner.sensorContext[2].bsln)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN0_OFFSET                                     (270u)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN0_SIZE                                       (2u)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN0_PARAM_ID                                   (0x0202010eu)

#define CY_CAPSENSE_BUTTON2_RX0_DIFF0_VALUE                                      (cy_capsense_tuner.sensorContext[2].diff)
#define CY_CAPSENSE_BUTTON2_RX0_DIFF0_OFFSET                                     (272u)
#define CY_CAPSENSE_BUTTON2_RX0_DIFF0_SIZE                                       (2u)
#define CY_CAPSENSE_BUTTON2_RX0_DIFF0_PARAM_ID                                   (0x02020110u)

#define CY_CAPSENSE_BUTTON2_RX0_STATUS0_VALUE                                    (cy_capsense_tuner.sensorContext[2].status)
#define CY_CAPSENSE_BUTTON2_RX0_STATUS0_OFFSET                                   (274u)
#define CY_CAPSENSE_BUTTON2_RX0_STATUS0_SIZE                                     (1u)
#define CY_CAPSENSE_BUTTON2_RX0_STATUS0_PARAM_ID                                 (0x01020112u)

#define CY_CAPSENSE_BUTTON2_RX0_NEG_BSLN_RST_CNT0_VALUE                          (cy_capsense_tuner.sensorContext[2].negBslnRstCnt)
#define CY_CAPSENSE_BUTTON2_RX0_NEG_BSLN_RST_CNT0_OFFSET                         (275u)
#define CY_CAPSENSE_BUTTON2_RX0_NEG_BSLN_RST_CNT0_SIZE                           (1u)
#define CY_CAPSENSE_BUTTON2_RX0_NEG_BSLN_RST_CNT0_PARAM_ID                       (0x01020113u)

#define CY_CAPSENSE_BUTTON2_RX0_IDAC0_VALUE                                      (cy_capsense_tuner.sensorContext[2].idacComp)
#define CY_CAPSENSE_BUTTON2_RX0_IDAC0_OFFSET                                     (276u)
#define CY_CAPSENSE_BUTTON2_RX0_IDAC0_SIZE                                       (1u)
#define CY_CAPSENSE_BUTTON2_RX0_IDAC0_PARAM_ID                                   (0x01020114u)

#define CY_CAPSENSE_BUTTON2_RX0_BSLN_EXT0_VALUE                                  (cy_capsense_tuner.sensorContext[2].bslnExt)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN_EXT0_OFFSET                                 (277u)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN_EXT0_SIZE                                   (1u)
#define CY_CAPSENSE_BUTTON2_RX0_BSLN_EXT0_PARAM_ID                               (0x01020115u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[3].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_RAW0_OFFSET                               (278u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_RAW0_PARAM_ID                             (0x02030116u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[3].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN0_OFFSET                              (280u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN0_PARAM_ID                            (0x02030118u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[3].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_DIFF0_OFFSET                              (282u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_DIFF0_PARAM_ID                            (0x0203011au)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[3].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_STATUS0_OFFSET                            (284u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_STATUS0_PARAM_ID                          (0x0103011cu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[3].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_NEG_BSLN_RST_CNT0_OFFSET                  (285u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_NEG_BSLN_RST_CNT0_PARAM_ID                (0x0103011du)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[3].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_IDAC0_OFFSET                              (286u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_IDAC0_PARAM_ID                            (0x0103011eu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[3].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN_EXT0_OFFSET                          (287u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_BSLN_EXT0_PARAM_ID                        (0x0103011fu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[4].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_RAW0_OFFSET                               (288u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_RAW0_PARAM_ID                             (0x02030120u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[4].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN0_OFFSET                              (290u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN0_PARAM_ID                            (0x02030122u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[4].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_DIFF0_OFFSET                              (292u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_DIFF0_PARAM_ID                            (0x02030124u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[4].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_STATUS0_OFFSET                            (294u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_STATUS0_PARAM_ID                          (0x01030126u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[4].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_NEG_BSLN_RST_CNT0_OFFSET                  (295u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_NEG_BSLN_RST_CNT0_PARAM_ID                (0x01030127u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[4].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_IDAC0_OFFSET                              (296u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_IDAC0_PARAM_ID                            (0x01030128u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[4].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN_EXT0_OFFSET                          (297u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_BSLN_EXT0_PARAM_ID                        (0x01030129u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[5].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_RAW0_OFFSET                               (298u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_RAW0_PARAM_ID                             (0x0203012au)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[5].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN0_OFFSET                              (300u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN0_PARAM_ID                            (0x0203012cu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[5].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_DIFF0_OFFSET                              (302u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_DIFF0_PARAM_ID                            (0x0203012eu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[5].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_STATUS0_OFFSET                            (304u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_STATUS0_PARAM_ID                          (0x01030130u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[5].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_NEG_BSLN_RST_CNT0_OFFSET                  (305u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_NEG_BSLN_RST_CNT0_PARAM_ID                (0x01030131u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[5].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_IDAC0_OFFSET                              (306u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_IDAC0_PARAM_ID                            (0x01030132u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[5].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN_EXT0_OFFSET                          (307u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_BSLN_EXT0_PARAM_ID                        (0x01030133u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[6].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_RAW0_OFFSET                               (308u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_RAW0_PARAM_ID                             (0x02030134u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[6].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN0_OFFSET                              (310u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN0_PARAM_ID                            (0x02030136u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[6].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_DIFF0_OFFSET                              (312u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_DIFF0_PARAM_ID                            (0x02030138u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[6].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_STATUS0_OFFSET                            (314u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_STATUS0_PARAM_ID                          (0x0103013au)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[6].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_NEG_BSLN_RST_CNT0_OFFSET                  (315u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_NEG_BSLN_RST_CNT0_PARAM_ID                (0x0103013bu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[6].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_IDAC0_OFFSET                              (316u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_IDAC0_PARAM_ID                            (0x0103013cu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[6].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN_EXT0_OFFSET                          (317u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_BSLN_EXT0_PARAM_ID                        (0x0103013du)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_RAW0_VALUE                                (cy_capsense_tuner.sensorContext[7].raw)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_RAW0_OFFSET                               (318u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_RAW0_SIZE                                 (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_RAW0_PARAM_ID                             (0x0203013eu)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN0_VALUE                               (cy_capsense_tuner.sensorContext[7].bsln)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN0_OFFSET                              (320u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN0_PARAM_ID                            (0x02030140u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_DIFF0_VALUE                               (cy_capsense_tuner.sensorContext[7].diff)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_DIFF0_OFFSET                              (322u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_DIFF0_SIZE                                (2u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_DIFF0_PARAM_ID                            (0x02030142u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_STATUS0_VALUE                             (cy_capsense_tuner.sensorContext[7].status)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_STATUS0_OFFSET                            (324u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_STATUS0_SIZE                              (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_STATUS0_PARAM_ID                          (0x01030144u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_NEG_BSLN_RST_CNT0_VALUE                   (cy_capsense_tuner.sensorContext[7].negBslnRstCnt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_NEG_BSLN_RST_CNT0_OFFSET                  (325u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_NEG_BSLN_RST_CNT0_SIZE                    (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_NEG_BSLN_RST_CNT0_PARAM_ID                (0x01030145u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_IDAC0_VALUE                               (cy_capsense_tuner.sensorContext[7].idacComp)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_IDAC0_OFFSET                              (326u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_IDAC0_SIZE                                (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_IDAC0_PARAM_ID                            (0x01030146u)

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN_EXT0_VALUE                           (cy_capsense_tuner.sensorContext[7].bslnExt)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN_EXT0_OFFSET                          (327u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN_EXT0_SIZE                            (1u)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_BSLN_EXT0_PARAM_ID                        (0x01030147u)

#define CY_CAPSENSE_LINEARSLIDER0_X0_VALUE                                       (cy_capsense_tuner.position[0].x)
#define CY_CAPSENSE_LINEARSLIDER0_X0_OFFSET                                      (328u)
#define CY_CAPSENSE_LINEARSLIDER0_X0_SIZE                                        (2u)
#define CY_CAPSENSE_LINEARSLIDER0_X0_PARAM_ID                                    (0x02030148u)

#define CY_CAPSENSE_LINEARSLIDER0_Y0_VALUE                                       (cy_capsense_tuner.position[0].y)
#define CY_CAPSENSE_LINEARSLIDER0_Y0_OFFSET                                      (330u)
#define CY_CAPSENSE_LINEARSLIDER0_Y0_SIZE                                        (2u)
#define CY_CAPSENSE_LINEARSLIDER0_Y0_PARAM_ID                                    (0x0203014au)

#define CY_CAPSENSE_LINEARSLIDER0_Z0_VALUE                                       (cy_capsense_tuner.position[0].z)
#define CY_CAPSENSE_LINEARSLIDER0_Z0_OFFSET                                      (332u)
#define CY_CAPSENSE_LINEARSLIDER0_Z0_SIZE                                        (2u)
#define CY_CAPSENSE_LINEARSLIDER0_Z0_PARAM_ID                                    (0x0203014cu)

#define CY_CAPSENSE_LINEARSLIDER0_ID0_VALUE                                      (cy_capsense_tuner.position[0].id)
#define CY_CAPSENSE_LINEARSLIDER0_ID0_OFFSET                                     (334u)
#define CY_CAPSENSE_LINEARSLIDER0_ID0_SIZE                                       (2u)
#define CY_CAPSENSE_LINEARSLIDER0_ID0_PARAM_ID                                   (0x0203014eu)
...
#define CY_CAPSENSE_BUTTON2_RX0_PIN0_PC_PTR_VALUE                                (cy_capsense_context.ptrPinConfig[4].pcPtr)
#define CY_CAPSENSE_BUTTON2_RX0_PIN0_PC_PTR_SIZE                                 (sizeof(cy_capsense_context.ptrPinConfig[4].pcPtr))
#define CY_CAPSENSE_BUTTON2_RX0_PIN0_NUMBER_VALUE                                (cy_capsense_context.ptrPinConfig[4].pinNumber)
#define CY_CAPSENSE_BUTTON2_RX0_PIN0_NUMBER_SIZE                                 (sizeof(cy_capsense_context.ptrPinConfig[4].pinNumber))

#define CY_CAPSENSE_BUTTON2_TX_PIN0_PC_PTR_VALUE                                 (cy_capsense_context.ptrPinConfig[5].pcPtr)
#define CY_CAPSENSE_BUTTON2_TX_PIN0_PC_PTR_SIZE                                  (sizeof(cy_capsense_context.ptrPinConfig[5].pcPtr))
#define CY_CAPSENSE_BUTTON2_TX_PIN0_NUMBER_VALUE                                 (cy_capsense_context.ptrPinConfig[5].pinNumber)
#define CY_CAPSENSE_BUTTON2_TX_PIN0_NUMBER_SIZE                                  (sizeof(cy_capsense_context.ptrPinConfig[5].pinNumber))

#define CY_CAPSENSE_LINEARSLIDER0_SNS0_PIN0_PC_PTR_VALUE                         (cy_capsense_context.ptrPinConfig[6].pcPtr)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_PIN0_PC_PTR_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[6].pcPtr))
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_PIN0_NUMBER_VALUE                         (cy_capsense_context.ptrPinConfig[6].pinNumber)
#define CY_CAPSENSE_LINEARSLIDER0_SNS0_PIN0_NUMBER_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[6].pinNumber))

#define CY_CAPSENSE_LINEARSLIDER0_SNS1_PIN0_PC_PTR_VALUE                         (cy_capsense_context.ptrPinConfig[7].pcPtr)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_PIN0_PC_PTR_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[7].pcPtr))
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_PIN0_NUMBER_VALUE                         (cy_capsense_context.ptrPinConfig[7].pinNumber)
#define CY_CAPSENSE_LINEARSLIDER0_SNS1_PIN0_NUMBER_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[7].pinNumber))

#define CY_CAPSENSE_LINEARSLIDER0_SNS2_PIN0_PC_PTR_VALUE                         (cy_capsense_context.ptrPinConfig[8].pcPtr)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_PIN0_PC_PTR_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[8].pcPtr))
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_PIN0_NUMBER_VALUE                         (cy_capsense_context.ptrPinConfig[8].pinNumber)
#define CY_CAPSENSE_LINEARSLIDER0_SNS2_PIN0_NUMBER_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[8].pinNumber))

#define CY_CAPSENSE_LINEARSLIDER0_SNS3_PIN0_PC_PTR_VALUE                         (cy_capsense_context.ptrPinConfig[9].pcPtr)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_PIN0_PC_PTR_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[9].pcPtr))
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_PIN0_NUMBER_VALUE                         (cy_capsense_context.ptrPinConfig[9].pinNumber)
#define CY_CAPSENSE_LINEARSLIDER0_SNS3_PIN0_NUMBER_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[9].pinNumber))

#define CY_CAPSENSE_LINEARSLIDER0_SNS4_PIN0_PC_PTR_VALUE                         (cy_capsense_context.ptrPinConfig[10].pcPtr)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_PIN0_PC_PTR_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[10].pcPtr))
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_PIN0_NUMBER_VALUE                         (cy_capsense_context.ptrPinConfig[10].pinNumber)
#define CY_CAPSENSE_LINEARSLIDER0_SNS4_PIN0_NUMBER_SIZE                          (sizeof(cy_capsense_context.ptrPinConfig[10].pinNumber))
...
#define CY_CAPSENSE_BUTTON2_RX0_CFG_PTR_VALUE                                    (cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[0].ptrPin)
#define CY_CAPSENSE_BUTTON2_RX0_CFG_PTR_SIZE                                     (sizeof(cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[0].ptrPin))
#define CY_CAPSENSE_BUTTON2_RX0_ELTD_TYPE_VALUE                                  (cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[0].type)
#define CY_CAPSENSE_BUTTON2_RX0_ELTD_TYPE_SIZE                                   (sizeof(cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[0].type))
#define CY_CAPSENSE_BUTTON2_RX0_NUM_PINS_VALUE                                   (cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[0].numPins)
#define CY_CAPSENSE_BUTTON2_RX0_NUM_PINS_SIZE                                    (sizeof(cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[0].numPins))

#define CY_CAPSENSE_BUTTON2_TX_CFG_PTR_VALUE                                     (cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[1].ptrPin)
#define CY_CAPSENSE_BUTTON2_TX_CFG_PTR_SIZE                                      (sizeof(cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[1].ptrPin))
#define CY_CAPSENSE_BUTTON2_TX_ELTD_TYPE_VALUE                                   (cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[1].type)
#define CY_CAPSENSE_BUTTON2_TX_ELTD_TYPE_SIZE                                    (sizeof(cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[1].type))
#define CY_CAPSENSE_BUTTON2_TX_NUM_PINS_VALUE                                    (cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[1].numPins)
#define CY_CAPSENSE_BUTTON2_TX_NUM_PINS_SIZE                                     (sizeof(cy_capsense_context.ptrWdConfig[2].ptrEltdConfig[1].numPins))
...
#if ((CY_CAPSENSE_PERI_CLK / 1 / 120) > 3000000)
...
#if ((CY_CAPSENSE_PERI_CLK / 1 / 120) > 3000000)
    #warning The maximum Tx clock frequency is 3 MHz: increase Tx clock divider for widget Button2 to meet the valid operation conditions
#endif

#if ((CY_CAPSENSE_PERI_CLK / 1 / 16) > 6000000)
